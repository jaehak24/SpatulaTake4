...
public class SelectDataDialog extends Dialog implements View.OnClickListener, OnCalendarClickListener {
    ...
    public SelectDataDialog(Context context, OnSelectDateListener onSelectDateListener, int year, int month, int day, int position) {
