...
import com.common.spatulatake4.activity.ScheduleDetailActivity;
import com.common.spatulatake4.fragment.ScheduleFragment;
...
import com.common.spatulatake4.widget.StrikeThruTextView;
...
public class ScheduleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ScheduleViewHolder) {
            ...
            viewHolder.vScheduleHintBlock.setBackgroundResource(SpatulaUtils.getScheduleBlockView(schedule.getColor()));
            viewHolder.tvScheduleTitle.setText(schedule.getTitle());
            if (schedule.getTime() != 0) {
                viewHolder.tvScheduleTime.setText(SpatulaUtils.timeStamp2Time(schedule.getTime()));
            } else {
