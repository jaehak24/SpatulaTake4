...
public class WeekCalendarView extends ViewPager implements OnWeekClickListener{
    ...
    * onCalendarClickListener*/
    public SparseArray<WeekView> getWeekViews(){return mWeekAdapter.getViews();}

    public weekAdapter getWeekAdapter(){ return mWeekAdapter;}

    public WeekView getCurrentWeekView(){return getWeekViews().get(getCurrentItem());}
